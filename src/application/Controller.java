...
public class Controller {
	...
	public void initialize() {
		...
		TranslateTransition translateTransition0 = new TranslateTransition(Duration.seconds(0.1), name);
		translateTransition0.setByY(700);
		translateTransition0.play();

		TranslateTransition translateTransition00 = new TranslateTransition(Duration.seconds(0.1), message);
		...
		translateTransition.setOnFinished(event -> {
			...
			translateTransition1.setOnFinished(event1 -> {
				...
				TranslateTransition translateTransition11 = new TranslateTransition(Duration.seconds(1), name);
				...
				translateTransition11.setOnFinished(event2 -> {
					...
					translateTransition111.setOnFinished(event3 -> {
						...
						fadeTransition.setOnFinished(event4 -> {
							...
							FadeTransition fadeTransition1 = new FadeTransition(Duration.seconds(2), mainPane);
